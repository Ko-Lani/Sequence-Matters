...
for object in "${objects[@]}"; do
    ...
    # ffmpeg 명령 실행
    ffmpeg -framerate 10 \
        -i /hdd_1/laniko/Dataset/project_page/nerfsr/bicubic_white/"$object"_01/test/ours_30000/renders/r_%d.png \
        -c:v libx264 \
        -pix_fmt yuv420p \
        /hdd_1/laniko/AAAI/ProPainter_website/assets/video_blender/nerfsr/nerfsr_"$object".mp4
